L.Control.voronoiLogo = L.Control.extend({
  ...
  onAdd: function(map) {
    ...
    div.innerHTML = 
      `<table border=1 cellspacing=0 cellpadding=0 bgcolor='#000080'>
        <tr bgcolor='#000080'>
          <td align="center">
            <font size='+1' color='#FFFFFF'><b>PM2.5 Voronoi Diagram</b></font>
          </td>
        </tr>
        <tr bgcolor='#ffffff'>
          <td align='center' style="padding: 3px 5px;">
            ...
            <a target="_blank" rel="noopener noreferrer" style="text-decoration: none" href='https://github.com/HuangLiPang/pm2.5-voronoi-map'>
...
L.control.voronoiLogo = function(options) {
  return new L.Control.voronoiLogo(options);
}